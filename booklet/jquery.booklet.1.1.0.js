...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function resetPages(){		
		...
		//update css
		wraps.attr('style','');
		wraps.css({'width':opts.pWidth, 'height':opts.pHeight});
	...
	function initAnim(diff, inc, shadow){		
		...
		if(inc && diff > 2){
			...
			b.find('.b-page-'+opts.curr+' .b-wrap').show().css({'width':opts.pWidth, 'height':opts.pHeight});
			b.find('.b-page-'+(opts.curr+1)+' .b-wrap').show().css({'width':opts.pWidth, 'height':opts.pHeight});
